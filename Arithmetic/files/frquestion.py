...
def create_frq(list, index, q_width=300, max_=9999):
  ...
  return grid
#Question 1  
frq_1 = create_frq(frquestions, 0, 600)
...
#Question 2
frq_2 = create_frq(frquestions, 1, 600)
...
#Question 3
frq_3 = create_frq(frquestions, 2, 600)
...
#Question 9
frq_9 = create_frq(frquestions, 8, 450)
...
#Question 12
frq_12 = create_frq(frquestions, 11, 450)
...
#Question 16
frq_16 = create_frq(frquestions, 15, 450)
